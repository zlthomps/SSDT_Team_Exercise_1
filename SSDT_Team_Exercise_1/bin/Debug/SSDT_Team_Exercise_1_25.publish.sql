...
GO
PRINT N'Dropping DF__Salespers__isAct__2BFE89A6...';


GO
ALTER TABLE [Person].[Salesperson] DROP CONSTRAINT [DF__Salespers__isAct__2BFE89A6];


GO
PRINT N'Altering [Person].[Salesperson]...';
